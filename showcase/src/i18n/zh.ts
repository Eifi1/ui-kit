...
export const zh: Dictionary = {
  ...
  pages: {
    ...
    "month-view": {
      ...
      short: "月视图",
      blurb:
        "作为页面的日历：带格线的月份，每天的事件画在其格子里，由页面自己的标题栏驱动，并为选中的日期提供一个面板。",
    },
    "month-time": {
      title: "月份与时间",
      short: "月份与时间",
    ...
    "calendar-heatmap": {
      ...
      short: "热力图",
      blurb:
        "以深浅方块表示每一天：按周排列的一年或单个月份，可选择的日期，色阶的级数、上限和颜色，截取为最近几天的长时间窗口，以及从右到左。",
    },
    layout: {
      title: "折叠区域与对话框框架",
      short: "折叠",
    ...
    "floating-actions": {
      ...
      short: "悬浮",
      blurb:
        "角落里的控件：报告状态并在变化时播报的扩展按钮、悬浮按钮上的组件库提示框，以及由角落开关、链接和计数组成的胶囊栏。",
    },
    popovers: {
      title: "弹出框、菜单与工具提示",
      short: "弹出框",
